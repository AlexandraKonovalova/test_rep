...
r = re.search('...', s)
if r:
    string1 = r.group(1)    #в строку помещается все, что находится. в Скобках функции group() - номер выражения в скобках ()
    string2 = r.group(2)
    print(string)
    ...
    Посик емэйла:
        '([a-z]+)@\\1\.ru' - что-то типа admin@admin.ru
        
        чтобы не работала функция слэша: \\1
        или r'\1'
        r'\n\' - экранируются все слэши, кроме последнего
